...
public class TeamController {
    @Autowired
    TeamService teamServiceImplArraylist;
    @Autowired
    ...
    @PutMapping("/{teamId}")
    public ResponseEntity<Void> updateTeam( @PathVariable Integer teamId, @RequestBody Team team) throws SQLException {
    ...
    public ResponseEntity<Integer> addTeamToArrayList(Team team) throws SQLException {
